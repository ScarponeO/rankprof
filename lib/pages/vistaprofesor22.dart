...
class VistaProfssor22 extends StatefulWidget {
  ...
  VistaProfssor22(
      {Key key, this.documents, this.profesor, this.materia3, this.puntotal, this.usuarioserio, this.id, this.cont})
      : departamentos = documents.fold({}, (Map<String, String> map, document) {
        ...
        ranking1 = documents
            .map((doc) => doc['R.disponibilidad'])
            .fold(0, (a, b) => a + b),
        ranking2 =
            documents.map((doc) => doc['R.exigencia']).fold(0, (a, b) => a + b),
        ranking3 =
            documents.map((doc) => doc['R.interaccion']).fold(0, (a, b) => a + b),
        ranking4 = documents
            .map((doc) => doc['R.pedagogia'])
            .fold(0, (a, b) => a + b),
        ranking5 =
            documents.map((doc) => doc['R.responsabilidad']).fold(0, (a, b) => a + b),
        
        total = documents.map((doc) => doc['tota']).fold(0, (a, b) => a + b),
        super(key: key);
...
class _VistaProfssorState extends State<VistaProfssor22> {
  double hola = 3;
